...
//    GpioCtrlRegs.GPAPUD.bit.GPIO23 = 1;    // Disable pull-up on GPIO23 (EQEP1I)
    ...
    /*
    GpioCtrlRegs.GPBPUD.bit.GPIO50 = 0;    // Enables pull-up on GPIO50 (EQEP1A)
    GpioCtrlRegs.GPBPUD.bit.GPIO51 = 0;    // Enables pull-up on GPIO51 (EQEP1B)
    GpioCtrlRegs.GPBPUD.bit.GPIO52 = 0;    // Enables pull-up on GPIO52 (EQEP1S)
    GpioCtrlRegs.GPBPUD.bit.GPIO53 = 0;    // Enables pull-up on GPIO53 (EQEP1I)
    */
...
/*
    GpioCtrlRegs.GPAPUD.bit.GPIO28 = 0;    // Enables pull-up on GPIO28 (EQEP3A)
    GpioCtrlRegs.GPAPUD.bit.GPIO29 = 0;    // Enables pull-up on GPIO29 (EQEP3B)
*/
...
//    GpioCtrlRegs.GPAMUX1.bit.GPIO9 = 1;     // Configure GPIO9 as EQEP3I
    ...
    GpioCtrlRegs.GPAMUX2.bit.GPIO28 = 2;//6;    // Configure GPIO28 as EQEP3A
    GpioCtrlRegs.GPAGMUX2.bit.GPIO29 = 1;   // Configure GPIO29 as EQEP3B
    GpioCtrlRegs.GPAMUX2.bit.GPIO29 = 2;//6;    // Configure GPIO29 as EQEP3B
